...
rootpath=./
export HF_HOME=$rootpath/jianhuipang_qy3/hf_cache
export TRANSFORMERS_CACHE=$rootpath/jianhuipang_qy3/hf_cache

train_path=$rootpath/jianhuipang_qy3/gogollm/run_allms.py
...
model_path=$rootpath/jianhuipang_qy3/apdcephfs/jianhuipang/gogollm/newmodels/checkpoints_ct/ac/allm-ac-7b
...
datafile=$rootpath/jianhuipang_qy3/datasets/alpaca-gpt4/train.addac.json
# datafile=$rootpath//jianhuipang/gogollm/data/newstest17to20.de2en.cat.gpt4comaalpaca.hf.shuf.json
echo $datafile
evalfile=$rootpath/jianhuipang_qy3/datasets/alpaca-gpt4/eval.addac.json
