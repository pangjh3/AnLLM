...
export HF_HOME=$rootpath/jianhuipang/hf_cache2
export TRANSFORMERS_CACHE=$rootpath/jianhuipang/hf_cache2
...
model_path=$rootpath/jianhuipang/gogollm/newmodels/checkpoints_ct/punc/allm-juhao-7b
...
datafile=$rootpath/jianhuipang/datasets/alpaca-gpt4/train.hf.addcoma.json
# datafile=$rootpath/jianhuipang/gogollm/data/newstest17to20.de2en.cat.gpt4comaalpaca.hf.shuf.json
echo $datafile
evalfile=$rootpath/jianhuipang/datasets/alpaca-gpt4/eval.hf.addcoma.json
